...
static propTypes = {
  ...
  async componentDidMount() {
    //console.log('cdm');
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=4eae62a8157545deb7af46399afb93dd&page=1&pageSize=${this.props.pageSize}`;
